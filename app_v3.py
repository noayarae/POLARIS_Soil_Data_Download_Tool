"""
Created on Wed Jun 24 17:46:07 2024
@author: efrain.noa-yarasca

This code launches the "POLARIS Soil Data Download" tool, enabling users to download customized POLARIS soil data 
for a specified region. The primary input required is the destination folder for storing the downloaded raster files. 
